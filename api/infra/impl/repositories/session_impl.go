...
func (s *SessionRepositoryImpl) GetAuth(auth *entities.AccessDetails) (string, error) {
...
func (s *SessionRepositoryImpl) CreateAuth(userid string, td *entities.TokenDetails) error {
...
func (s *SessionRepositoryImpl) DeleteAuth(uuid string) (int64, error) {
